...
group1_widget = widgets.SelectMultiple(
    options=['Все'] + sales_data['Группа (вид1)'].unique().tolist(),
    description='Группа (вид1):',
    value=['Все']
)

subgroup2_widget = widgets.SelectMultiple(
    options=['Все'] + sales_data['Подгруппа (вид2)'].unique().tolist(),
    description='Подгруппа (вид2):',
    value=['Все']
)

department1_widget = widgets.SelectMultiple(
    options=['Все'] + sales_data['Подразделение1'].unique().tolist(),
    description='Подразделение1:',
    value=['Все']
)

department2_widget = widgets.SelectMultiple(
    options=['Все'] + sales_data['Подразделение2'].unique().tolist(),
    description='Подразделение2:',
    value=['Все']
)
...
def update_map(button):
    with map_output:
        ...
        group1 = list(group1_widget.value)
        subgroup2 = list(subgroup2_widget.value)
        department1 = list(department1_widget.value)
        department2 = list(department2_widget.value)
